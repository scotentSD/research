...
- **Effective voice:** employers create a safe environment where dialogue and challenges are dealt with constructively, and where employee views are sought out, listened to and can make a difference<br>
- **Opportunity:** fair opportunity allows people to access and progress in work and employment<br>
- **Security:** people have reasonable security and stability of employment, income and work<br>
- **Fulfilment:** people have access to fulfilling work<br>
- **Respect:** people are treated respectfully, whatever their role and status<br>

Businesses that commit to Fair Work must sign up to these principles:

- **Appropriate channels** for effective voice and employee engagement, such as trade union recognition<br>
- Investment in **workforce development**<br>
- Actions to tackle the **gender pay gap** and create a more **diverse and inclusive workplace**<br>
- No inappropriate use of **zero-hours contracts**<br>
- **Paying the Real Living Wage** (currently £9.50 in Scotland)<br>
## Files
- [Fair work & Net Zero](content/files/Fair-Work-and-Net-Zero.pdf)

## Overview<br>
Fair work has two main areas that we have experienced<br>
1. Language (and how poorly it works in this area)<br>
2. Fundamental understanding of what Fair Work is<br>

# Fair Work Tools and Sites
- [Fair Work Employer Support Tool](https://fairworktool.scot)
- [Livingwage.org.uk](https://livingwage.org.uk)
- [Scottish Gov Fair Work First guidance](https://www.gov.scot/publications/fair-work-first-guidance-3)
- [Close the gap](https://www.closethegap.org.uk)


## 2021 Round 1

???note "Tested 5 Themes"
	#### Themes<br>
	  - Effective voice<br>
	  - Opportunity<br>
	  - Security<br>
...
???note "We also asked them:"
	 - Can people commit to this. <br>
	 - Can a company answer yes or no based on this description. (Why Not)<br>
	 - Would they be able to say they meet each of the 5 criteria<br>or<br>
     - Will they commit to work towards the criteria<br>
     - Do people understand why we are embedding the 5 criteria<br>
	<br>
	<br>
...
???note "Asked them to suggest percentage compliance with 7 statement"
	- % of staff paid RLW (i.e. less than 50% or more than 50%)<br>
	- % of staff on zero hour contracts (i.e. less than 50% or more than 50%)<br>
	- % Gender pay gap (less than 50% or more than 50%)<br>
	- % of females in leadership roles (0-10%; 10-30%; 30-50% over 50%)<br>
	- % of young people employed (0-10%; 10-30%; 30-50% over 50%)<br>
	- % of staff trained in the past 12 months<br>
	- % of staff consulted in past 12 months (i.e. staff survey)<br>

### Findings
- People do not understand Fair work Well. 
- Industries experienece/welcome/implement Fair Work and Living Wage very differently. <br> Some common pain points are: 
...
[@Lindsay Branston](mailto:lindsay.branston@scotent.co.uk) Just added one. Still looking for quotes for some of the other areas. [[KD2]](#_msoanchor_2)
